...
public class Stop {
    ...
    /** Coordinates this stop is located at, as LongLat */
    private final LongLat coordinates;

    /** Identifier for this stop, such as UUN or shop name*/
    private final String id;

    /** Order number that this pickup/drop-off is associated with */
