...
public class PathfindingNode extends LongLat implements Comparable<PathfindingNode> {
    ...
    /** 'f' weight, initialised as MAX_VAL */
    private double f = Double.MAX_VALUE;

    /** 'g' weight, initialised as MAX_VAL */
    private double g = Double.MAX_VALUE;

    /** Angle taken from parent to reach this node */
    private int angle;

    /** Pointer to parent node in pathfinding which came before */
    ...
    public boolean equals(Object obj) {
        ...
        return super.equals(other) && this.getF() == other.getF() && this.getG() == other.getG();
    }
