...
public class DroneMove {
    /** LongLat of the 'from' position of Drone */
    private final LongLat from;

    /** LongLat of the 'to' position of Drone */
    private final LongLat to;

    /** Angle taken to reach 'to' from 'from'  */
    private final int angle;

    /** Identifier such as orderNo for this DroneMove */
